qx.Class.define("qxl.testtapper.TreeItem", {
  ...
  members: {
    _addWidgets() {
      ...
      let passedContainer = new qx.ui.container.Composite(
        new qx.ui.layout.HBox()
      ).set({ width: 60 });
      let passedIcon = new qx.ui.basic.Image(
      ...
      let failedContainer = new qx.ui.container.Composite(
        new qx.ui.layout.HBox()
      ).set({ width: 60 });
      let failedIcon = new qx.ui.basic.Image(
